  ...
  if (scenery.includes('X') || scenery.includes('O')) {
    ...
    if (dispo.includes(4)) {
      if (
        ...
        adv.includes(3) && (adv.includes(5) || adv.includes(1) || adv.includes(7) || adv.includes(6)) ||
    ...
    if (
      my.includes(4) && dispo.includes(5) && dispo.includes(3) ||
      my.includes(8) && my.includes(4) && dispo.includes(1) && dispo.includes(2) && dispo.includes(5)
    ) {
      return 5
    }
    if (
    ...
    if (
      ...
      my.includes(0) && dispo.includes(4) && dispo.includes(6) && dispo.includes(3) && dispo.includes(7) && dispo.includes(8)
    ) {
      return 8
    }
